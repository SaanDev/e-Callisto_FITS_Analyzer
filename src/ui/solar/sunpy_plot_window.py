...
class SunPyPlotCanvas(QWidget):
    ...
    def set_gcs_overlay(self, x_arcsec, y_arcsec, *, visible: bool = True, layer: str = GCS_LAYER) -> None:
        ...
        ``src.backend.gcs.gcs_model.wireframe_arcsec`` or
        ``src.backend.gcs.shock_model.shock_wireframe_arcsec``.
        """
    ...
    def set_vector_field_overlay(self, geometry: Any | None) -> None:
        ...
        ``geometry`` is a :class:`~src.backend.solar.hmi_vector_field.VectorOverlayGeometry`
