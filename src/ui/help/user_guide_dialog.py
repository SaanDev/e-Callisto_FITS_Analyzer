...
from src.ui.help.user_guide_content import USER_GUIDE_HTML, build_default_stylesheet
...
class UserGuideDialog(QDialog):
    ...
    The guide HTML comes from ``src/ui/help/user_guide_content.py`` and is displayed
