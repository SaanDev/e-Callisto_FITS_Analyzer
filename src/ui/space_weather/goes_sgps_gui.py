...
from src.backend.space_weather.sep_proton import SepProtonRangeData, load_sep_proton_range
from src.ui.common.gui_shared import fit_window_to_screen
from src.ui.common.mpl_style import apply_origin_style, style_axes
