...
from src.core.paths import source_main_path, source_project_root
...
from src.backend.radio.artemis import db_scale_for_header, linear_unit_for_header
from src.backend.radio.fits_io import extract_ut_start_sec, load_callisto_fits
from src.backend.space_weather.goes_overlay import goes_overlay_payload_from_dict
from src.backend.session.project_report import ReportGenerationCancelled, generate_project_report_pdf
from src.backend.services.update_checker import check_for_updates
from src.backend.session.view_config import normalize_view_config
...
class TimelineProbeWorker(QObject, QRunnable):
    ...
    @Slot()
    def run(self):
        from src.backend.radio import callisto_timeline
