...
from src.backend.session.annotations import (
...
from src.backend.radio.artemis import db_scale_for_header, describe_artemis, suggested_display_range
from src.backend.radio.batch_processing import (
...
from src.backend.session.project_session import ProjectFormatError, read_project, write_project
from src.backend.session.project_report import (
    ProjectReportFigure,
    ProjectReportInput,
)
from src.backend.session.provenance import build_provenance_payload, write_provenance_files
from src.backend.radio.swaves import (
    DEFAULT_PAD_SECONDS as SWAVES_DEFAULT_PAD_SECONDS,
    SwavesPayload,
    format_log_frequency,
    log_frequency_ticks,
)
from src.backend.session.recovery_manager import (
    DEFAULT_MAX_SNAPSHOTS,
    latest_snapshot_path,
    load_recovery_snapshot,
    save_recovery_snapshot,
)
from src.backend.radio.noise_reduction import rowwise_baseline
from src.backend.radio.rfi_filters import clean_rfi, config_dict as rfi_config_dict
from src.backend.services.update_checker import GITHUB_REPO
from src.backend.session.view_config import (
...
from src.ui.widgets.accelerated_plot_widget import (
    AcceleratedPlotWidget,
)
from src.ui.downloads.callisto_downloader import CallistoDownloaderApp
...
from src.ui.radio.dialogs.combine_dialogs import (
    CombineFitsDialog,
...
from src.ui.radio.dialogs.light_curve_frequency_dialog import LightCurveFrequencyDialog
from src.ui.radio.dialogs.light_curve_settings_dialog import LightCurveSettingsDialog
...
from src.ui.space_weather.dst_index_gui import MainWindow as DstIndexWindow
...
from src.ui.space_weather.goes_sgps_gui import MainWindow as SepProtonWindow
from src.ui.space_weather.goes_xrs_gui import MainWindow as GoesXrsWindow
from src.ui.space_weather.kp_index_gui import MainWindow as KpIndexWindow
from src.ui.downloads.learmonth_downloader import LearmonthDownloaderApp
...
from src.ui.app.gui_workers import (
...
from src.ui.cme.cme_helper_client import CMEHelperClient
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, theme=None, *args, **kwargs):
        ...
        low_value_row.addWidget(low_value_card, 0)
        low_row.addWidget(lbl_low)
        low_row.addLayout(low_value_row)
        ...
        high_value_row.addWidget(high_value_card, 0)
        high_row.addWidget(lbl_high)
        high_row.addLayout(high_value_row)
    ...
    def _on_downloader_import_finished(self, payload):
        ...
        try:
            ...
            if kind == "frequency_options_required":
                ...
                from src.backend.radio.burst_processor import combine_compatible
    ...
    def launch_swaves_downloader(self):
        from src.ui.downloads.swaves_downloader import SwavesDownloaderApp
    ...
    def open_sunpy_window(self):
        from src.ui.solar.sunpy_solar_viewer import SunPySolarViewer  # import here, not at top
        try:
    ...
    def open_gcs_fitting_window(self):
        ...
        from src.ui.gcs.gcs_fitting_window import GCSFittingWindow  # import here, not at top
    ...
    def open_solar_data_analysis_window(self):
        try:
            from src.ui.solar.solar_data_analysis_window import SolarDataAnalysisWindow  # import here, not at top
        except Exception as exc:
    ...
    def open_cme_viewer(self):
        from src.ui.cme.soho_lasco_viewer import CMEViewer  # import here, not at top
        try:
