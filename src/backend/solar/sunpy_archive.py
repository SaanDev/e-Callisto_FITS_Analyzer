...
def build_attrs(
    ...
    if entry.supports_product:
        ...
        if product and hasattr(attrs_module, "Physobs"):
            try:
                from src.backend.solar.jsoc_client import hmi_physobs
...
def fetch_via_jsoc(
    ...
    *,
    ...
    from src.backend.solar.jsoc_client import export_urls
    ...
    if data_kind == DATA_KIND_MAP:
        ...
        if map_loader is None:
            ...
            if instrument_name == "SUVI":
                ...
                # suvi_ingest).
                from src.backend.solar.suvi_ingest import load_suvi_map
                ...
                from src.backend.solar.lasco_ingest import load_lasco_map
