...
if TYPE_CHECKING:
    ...
    from src.UI.callisto_downloader import CallistoEventCandidate
...
def filter_burst_candidates(
    ...
    *,
    ...
    from src.UI.callisto_downloader import CallistoEventCandidate, sort_event_candidates
...
class BurstFitsWorker(QObject):
    ...
    @Slot()
    def run(self):
        from src.UI.callisto_downloader import sort_event_candidates
