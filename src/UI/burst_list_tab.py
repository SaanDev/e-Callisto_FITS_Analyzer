...
from src.Backend.burst_list import (
    BurstEvent, BurstListCancelled, fetch_burst_events, filter_burst_events,
)
from src.UI.burst_fits import BurstFitsWorker
...
class BurstListTab(QWidget):
    ...
    def display_preview(self, payload):
        from src.UI.callisto_downloader import PreviewWindow
    ...
    def download_selected(self):
        from src.UI.callisto_downloader import EventDownloadTask
