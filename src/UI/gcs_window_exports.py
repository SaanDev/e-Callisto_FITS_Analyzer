...
the model wireframes (``_panel_wireframes``), and ``src.Backend.gcs_figures``
...
class GCSWindowExports:
    ...
    def _wireframe_style(self) -> Any:
        from src.Backend.gcs_figures import WireframeStyle
    ...
    def _viewpoints_figure(
        ...
        from src.Backend.gcs_figures import viewpoints_figure
    ...
    def write_movie(
        ...
        *,
        ...
        """
        from src.Backend.figure_export import figure_rgb
    ...
    def _report_input(
        ...
        from src.UI.gcs_viewpoint_panel import DIFFERENCE_MODES
