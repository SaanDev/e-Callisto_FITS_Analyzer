...
from src.backend.solar.solar_data_analysis import extract_map_frames, frame_observation_time
from src.backend.solar.sunpy_archive import SunPySearchRow, build_spec_for_observable
...
class MultiViewpointDialog(QDialog):
    ...
    def _build_ui(self) -> None:
        ...
        from src.ui.solar.solar_data_analysis_window import populate_observable_combo
    ...
    def _start_search(self) -> None:
        ...
        from src.ui.solar.sunpy_solar_viewer import SunPyWorker
    ...
    def _start_fetch(self, row_index: int) -> None:
        from src.ui.solar.sunpy_solar_viewer import SunPyWorker, _default_cache_dir
