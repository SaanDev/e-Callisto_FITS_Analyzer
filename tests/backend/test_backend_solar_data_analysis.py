...
from src.backend.solar import solar_data_analysis as solar_mod
...
def test_partition_prefers_total_brightness_over_polarizer_triplet():
    from src.backend.solar.solar_data_analysis import partition_frames_by_config
...
def test_polar_state_normalization():
    from src.backend.solar.solar_data_analysis import _polar_state
...
def test_exposures_differ():
    from src.backend.solar.solar_data_analysis import exposures_differ
...
def test_iter_rendered_movie_frames_normalize_exposure():
    from src.backend.solar.solar_data_analysis import iter_rendered_movie_frames
...
def test_dominant_shape_frames_drops_odd_sized_frames():
    from src.backend.solar.solar_data_analysis import dominant_shape_frames
...
def test_make_magnetogram_composite_draws_polarity_contours():
    from src.backend.solar.solar_data_analysis import make_magnetogram_composite
