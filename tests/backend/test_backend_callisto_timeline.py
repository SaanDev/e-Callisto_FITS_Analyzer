...
from src.backend.radio import callisto_timeline as timeline
from src.backend.radio.callisto_timeline import (
    TimelineUnavailable,
    describe_timeline,
    extended_paths,
...
def test_resolve_falls_back_to_the_archive_through_the_cache(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("src.backend.radio.callisto_cache.fetch_cached", fake_fetch)
