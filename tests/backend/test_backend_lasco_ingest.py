...
Unit tests for SOHO/LASCO ingestion (src/backend/solar/lasco_ingest.py).
...
from src.backend.solar import lasco_ingest
from src.backend.solar.lasco_ingest import (
    is_lasco_header,
    load_lasco_map,
    patch_lasco_header,
)
