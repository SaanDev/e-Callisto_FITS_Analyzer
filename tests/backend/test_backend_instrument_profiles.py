...
(src/backend/radio/instrument_profiles.py).
"""
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # SOHO/EIT reports its instrument two ways: level-zero files say "EIT",
        # calibrated L1 files spell the whole name out.
        (_Frame(instrument="EIT", detector="EIT"), DISK_EUV),
        (_Frame(instrument="Extreme-ultraviolet Imaging Telescope (EIT)", detector="EIT"), DISK_EUV),
