...
from src.backend.solar import sunpy_archive as sa
...
def test_fetch_via_jsoc_orchestrates_export_and_download(tmp_path: Path):
    ...
    class _FakeDM:
        ...
        def download(self, items, progress_cb=None, cancel_cb=None):
            from src.backend.services.download_manager import AggregateProgress, DownloadResult
...
def test_fetch_via_jsoc_builds_hmi_recordset(tmp_path: Path):
    ...
    class _FakeDM:
        def download(self, items, progress_cb=None, cancel_cb=None):
            from src.backend.services.download_manager import DownloadResult
