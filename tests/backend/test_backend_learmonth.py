...
from src.backend.radio.learmonth import (
...
from tests.helpers.learmonth import build_test_learmonth_srs, make_scan_rows
...
def test_download_learmonth_day_raises_not_found(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("src.backend.radio.learmonth.requests.get", lambda *_a, **_k: FakeResponse())
