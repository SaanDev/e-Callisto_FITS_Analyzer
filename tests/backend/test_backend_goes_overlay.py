...
from src.backend.space_weather import goes_overlay as goes_overlay_module
...
def test_fetch_goes_overlay_searches_all_satellites_and_selects_best(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("src.backend.space_weather.goes_overlay.search", fake_search)
    monkeypatch.setattr("src.backend.space_weather.goes_overlay.fetch", fake_fetch)
    monkeypatch.setattr("src.backend.space_weather.goes_overlay._load_goes_overlay_frame", fake_load_frame)
