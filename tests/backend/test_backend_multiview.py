...
Unit tests for multi-viewpoint reprojection (src/backend/solar/multiview.py).
...
from src.backend.solar.multiview import (  # noqa: E402
    SCREEN_PLANAR,
    SCREEN_SPHERICAL,
    SCREEN_SURFACE,
    CoalignedView,
...
def test_screen_is_forwarded_by_coalign_and_blink(monkeypatch):
    ...
    monkeypatch.setattr("src.backend.solar.multiview.reproject_map_to", fake_reproject)
    earth = make_view_map(0.0)
