...
Unit tests for GOES/SUVI L1b ingestion (src/backend/solar/suvi_ingest.py).
...
from src.backend.solar import suvi_ingest
from src.backend.solar.suvi_ingest import (
    is_suvi_header,
    load_suvi_map,
