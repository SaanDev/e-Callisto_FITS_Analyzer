...
Tests for the byte-accurate download engine (src/backend/services/download_manager.py).
"""
...
from src.backend.services.download_manager import (
    AggregateProgress,
    CacheByteMonitor,
    DownloadItem,
    DownloadManager,
...
def test_aggregate_progress_fraction_is_file_based_when_sizes_unknown():
    from src.backend.services.download_manager import FileProgress, STATUS_DONE, STATUS_DOWNLOADING
