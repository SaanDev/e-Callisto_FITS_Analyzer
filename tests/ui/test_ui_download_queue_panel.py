...
Tests for the rich download progress panel (src/ui/downloads/download_queue_panel.py).
"""
...
from src.backend.services.download_manager import AggregateProgress, FileProgress, STATUS_DOWNLOADING, STATUS_DONE
