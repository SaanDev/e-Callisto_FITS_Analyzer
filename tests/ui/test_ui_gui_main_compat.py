...
from src.ui.widgets.accelerated_plot_widget import pg
...
def test_type_ii_dialog_save_plot_exports_png(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "src.ui.radio.dialogs.type_ii_band_splitting_dialog.pick_export_path",
        lambda *_a, **_k: (str(out_path), "png"),
    )
    monkeypatch.setattr(
        "src.ui.radio.dialogs.type_ii_band_splitting_dialog.QMessageBox.information",
        lambda *_a, **_k: None,
    )
    monkeypatch.setattr(
        "src.ui.radio.dialogs.type_ii_band_splitting_dialog.QMessageBox.critical",
        lambda *_a, **_k: None,
    )
