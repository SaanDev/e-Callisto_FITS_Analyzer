...
from src.ui.solar.sunpy_plot_window import SunPyPlotCanvas, SunPyPlotWindow
from src.ui.solar import sunpy_solar_viewer as viewer_mod
from src.ui.solar.sunpy_solar_viewer import SunPySolarViewer
...
def test_worker_falls_back_to_vso_on_jsoc_error(monkeypatch, tmp_path):
    _app()
    from src.backend.solar.jsoc_client import JsocError
...
def test_sunpy_viewer_clear_cache_empties_folder(tmp_path):
    ...
    import src.ui.solar.sunpy_solar_viewer as viewer_mod
