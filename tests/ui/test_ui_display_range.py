...
def test_display_range_preset_save_apply_delete(monkeypatch):
    ...
    monkeypatch.setattr("src.ui.app.main_window.QInputDialog.getText", lambda *_a, **_k: ("Event Window", True))
    ...
    monkeypatch.setattr("src.ui.app.main_window.QInputDialog.getItem", lambda *_a, **_k: ("Event Window", True))
