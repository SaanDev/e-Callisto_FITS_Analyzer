"""The shock model in the three-viewpoint GCS window (src/ui/gcs/gcs_fitting_window.py).
...
from tests.ui.test_ui_gcs_window import _app, _flush, _sequence
...
from src.ui.gcs.gcs_fitting_window import GCS_MODEL, SHOCK_MODEL, GCSFittingWindow
from src.ui.solar.solar_measure_tools import ShockFitEntry, TrackingPanel
