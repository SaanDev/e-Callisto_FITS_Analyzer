...
from src.ui.cme import soho_lasco_viewer as cme_viewer
from src.ui.cme.cme_helper_client import HelperOpenResult
from src.ui.cme.cme_launcher import LaunchResult
from src.ui.common.url_opener import OpenResult
...
def test_fetch_catalog_outcome_handles_unpublished_month(monkeypatch):
    ...
    monkeypatch.setattr("src.ui.cme.soho_lasco_viewer.requests.get", fake_get)
...
def test_launch_movie_with_fallback_when_helper_fails(monkeypatch):
    ...
    monkeypatch.setattr("src.ui.cme.soho_lasco_viewer.launch_cme_helper", lambda *_a, **_k: helper_result)
    monkeypatch.setattr("src.ui.cme.soho_lasco_viewer.open_url_robust", lambda *_a, **_k: fallback_result)
...
def test_launch_movie_with_fallback_uses_persistent_client_when_available(monkeypatch):
    ...
    monkeypatch.setattr("src.ui.cme.soho_lasco_viewer._use_legacy_helper_mode", lambda: False)
