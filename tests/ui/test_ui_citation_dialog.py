...
from src.ui.help.citation_dialog import CitationDialog, RECOMMENDED_CITATION_TEXT
...
def test_citation_dialog_copy_citation_updates_clipboard(monkeypatch):
    _app()
    monkeypatch.setattr("src.ui.help.citation_dialog.QMessageBox.information", lambda *_a, **_k: 0)
    monkeypatch.setattr("src.ui.help.citation_dialog.QMessageBox.warning", lambda *_a, **_k: 0)
