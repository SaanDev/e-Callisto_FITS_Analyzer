...
Offscreen tests for the Compare Viewpoint dialog (src/ui/solar/multiview_dialog.py)
...
from src.backend.solar.sunpy_archive import SunPySearchRow
from src.ui.solar.multiview_dialog import MultiViewpointDialog, build_spec_for_observable
...
def test_window_compare_button_gating_and_original_frames(monkeypatch):
    ...
    import src.ui.solar.multiview_dialog as mv
