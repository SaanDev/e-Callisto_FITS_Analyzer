...
Unit tests for the spheroid and ellipsoid shock models (src/Backend/shock_model.py).
...
from src.Backend.gcs_model import GCSParameters, GCSViewpoint, ObserverGeometry, apex_arcsec, project_points_to_arcsec
