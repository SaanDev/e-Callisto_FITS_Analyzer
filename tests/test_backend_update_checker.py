...
def test_normalize_version():
    ...
    assert update_checker.normalize_version("2.5.0") == (2, 5, 0)
    assert update_checker.normalize_version("invalid") == ()


def test_is_newer_version():
    assert update_checker.is_newer_version("2.0", "2.2.1")
    assert update_checker.is_newer_version("2.2.1", "2.5.0")
    assert not update_checker.is_newer_version("2.5.0", "2.2.1")
